...
class EnsemblMetadataServicer(ensembl_metadata_pb2_grpc.EnsemblMetadataServicer):
    ...
    def GetSpeciesInformation(self, request, context):
        logger.info(f"Received RPC for GetSpeciesInformation with request: {request}")
        return utils.get_species_information(self.db, request.genome_uuid)

    def GetAssemblyInformation(self, request, context):
        logger.info(f"Received RPC for GetAssemblyInformation with request: {request}")
    ...
    def GetGenomesByAssemblyAccessionID(self, request, context):
        logger.info(f"Received RPC for GetGenomesByAssemblyAccessionID with request: {request}")
    ...
    def GetSubSpeciesInformation(self, request, context):
        logger.info(f"Received RPC for GetSubSpeciesInformation with request: {request}")
    ...
    def GetTopLevelStatistics(self, request, context):
        logger.info(f"Received RPC for GetTopLevelStatistics with request: {request}")
    ...
    def GetTopLevelStatisticsByUUID(self, request, context):
        logger.info(f"Received RPC for GetTopLevelStatisticsByUUID with request: {request}")
    ...
    def GetGenomesByKeyword(self, request, context):
        logger.info(f"Received RPC for GetGenomesByKeyword with request: {request}")
    ...
    def GetGenomeByName(self, request, context):
        logger.info(f"Received RPC for GetGenomeByName with request: {request}")
    ...
    def GetRelease(self, request, context):
        logger.info(f"Received RPC for GetRelease with request: {request}")
    ...
    def GetReleaseByUUID(self, request, context):
        logger.info(f"Received RPC for GetReleaseByUUID with request: {request}")
        return utils.release_by_uuid_iterator(self.db, request.genome_uuid)

    def GetGenomeSequence(self, request, context):
        logger.info(f"Received RPC for GetGenomeSequence with request: {request}")
    ...
    def GetAssemblyRegion(self, request, context):
        logger.info(f"Received RPC for GetAssemblyRegion with request: {request}")
        return utils.assembly_region_iterator(
            self.db, request.genome_uuid, request.chromosomal_only
        )

    def GetGenomeAssemblySequenceRegion(self, request, context):
        logger.info(f"Received RPC for GetGenomeAssemblySequenceRegion with request: {request}")
    ...
    def GetDatasetsListByUUID(self, request, context):
        logger.info(f"Received RPC for GetDatasetsListByUUID with request: {request}")
    ...
    def GetDatasetInformation(self, request, context):
        logger.info(f"Received RPC for GetDatasetInformation with request: {request}")
    ...
    def GetOrganismsGroupCount(self, request, context):
        logger.info(f"Received RPC for GetOrganismsGroupCount with request: {request}")
