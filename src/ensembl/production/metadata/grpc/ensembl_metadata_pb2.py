...
_EMPTYREQUEST = _descriptor.Descriptor(
  name='EmptyRequest',
  full_name='ensembl_metadata.EmptyRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
EmptyRequest = _reflection.GeneratedProtocolMessageType('EmptyRequest', (_message.Message,), {
  ...
  '__module__' : 'ensembl.production.metadata.grpc.ensembl_metadata_pb2'
  # @@protoc_insertion_point(class_scope:ensembl_metadata.EmptyRequest)
  })
