...
class Assembly(_message.Message):
    __slots__ = ["accession", "assembly_uuid", "ensembl_name", "is_reference", "level", "name", "tol_id", "ucsc_name", "url_name"]
...
class AssemblyInfo(_message.Message):
    __slots__ = ["accession", "assembly_uuid", "chromosomal", "length", "level", "md5", "name", "sequence_location", "sha512t24u"]
    ACCESSION_FIELD_NUMBER: _ClassVar[int]
    ASSEMBLY_UUID_FIELD_NUMBER: _ClassVar[int]
...
class AssemblyRegion(_message.Message):
    __slots__ = ["chromosomal", "length", "md5", "name", "rank", "sha512t24u"]
    CHROMOSOMAL_FIELD_NUMBER: _ClassVar[int]
    LENGTH_FIELD_NUMBER: _ClassVar[int]
    MD5_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
...
class AssemblyRegionRequest(_message.Message):
    __slots__ = ["chromosomal_only", "genome_uuid"]
...
class Attribute(_message.Message):
    __slots__ = ["description", "label", "name", "type"]
...
class AttributeStatistics(_message.Message):
    __slots__ = ["label", "name", "statistic_type", "statistic_value"]
    LABEL_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
...
class AttributesInfo(_message.Message):
    __slots__ = ["assembly_date", "assembly_level", "assembly_provider_name", "assembly_provider_url", "genebuild_last_geneset_update", "genebuild_method", "genebuild_method_display", "genebuild_provider_name", "genebuild_provider_url", "genebuild_provider_version", "genebuild_sample_gene", "genebuild_sample_location", "variation_sample_variant"]
...
class AttributesInfoByGenome(_message.Message):
    __slots__ = ["attributes_info", "genome_uuid"]
...
class BriefGenomeDetails(_message.Message):
    __slots__ = ["assembly", "created", "genome_uuid", "latest_genome", "organism", "release", "taxon"]
...
class DatasetAttributeValue(_message.Message):
    __slots__ = ["attribute_name", "attribute_value", "dataset_type", "dataset_uuid", "dataset_version"]
...
class DatasetAttributesValuesRequest(_message.Message):
    __slots__ = ["attribute_name", "dataset_type", "genome_uuid", "latest_only", "release_version"]
    ATTRIBUTE_NAME_FIELD_NUMBER: _ClassVar[int]
    DATASET_TYPE_FIELD_NUMBER: _ClassVar[int]
    GENOME_UUID_FIELD_NUMBER: _ClassVar[int]
...
class DatasetInfo(_message.Message):
    __slots__ = ["attribute_name", "attribute_type", "attribute_value", "dataset_label", "dataset_name", "dataset_source_type", "dataset_type_name", "dataset_type_topic", "dataset_uuid", "dataset_version", "release_date", "release_type", "release_version"]
    ATTRIBUTE_NAME_FIELD_NUMBER: _ClassVar[int]
...
class Datasets(_message.Message):
    __slots__ = ["datasets", "genome_uuid"]
...
class FTPLinksRequest(_message.Message):
    __slots__ = ["dataset_type", "genome_uuid", "release_version"]
    DATASET_TYPE_FIELD_NUMBER: _ClassVar[int]
    GENOME_UUID_FIELD_NUMBER: _ClassVar[int]
    RELEASE_VERSION_FIELD_NUMBER: _ClassVar[int]
    dataset_type: str
...
class Genome(_message.Message):
    __slots__ = ["assembly", "attributes_info", "created", "genome_uuid", "organism", "related_assemblies_count", "release", "taxon"]
    ASSEMBLY_FIELD_NUMBER: _ClassVar[int]
    ATTRIBUTES_INFO_FIELD_NUMBER: _ClassVar[int]
    CREATED_FIELD_NUMBER: _ClassVar[int]
    GENOME_UUID_FIELD_NUMBER: _ClassVar[int]
...
class GenomeAssemblySequenceRegion(_message.Message):
    __slots__ = ["chromosomal", "length", "md5", "name", "sha512t24u"]
    CHROMOSOMAL_FIELD_NUMBER: _ClassVar[int]
    LENGTH_FIELD_NUMBER: _ClassVar[int]
    MD5_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
...
class GenomeBySpecificKeywordRequest(_message.Message):
    __slots__ = ["assembly_accession_id", "assembly_name", "common_name", "ensembl_name", "release_version", "scientific_name", "scientific_parlance_name", "species_taxonomy_id", "tolid"]
...
class GenomeDatatypeRequest(_message.Message):
    __slots__ = ["dataset_type", "genome_uuid"]
    DATASET_TYPE_FIELD_NUMBER: _ClassVar[int]
    GENOME_UUID_FIELD_NUMBER: _ClassVar[int]
    dataset_type: str
    genome_uuid: str
...
class GenomeInfoRequest(_message.Message):
    __slots__ = ["assembly_name", "genebuild_date", "production_name", "release_version", "use_default"]
    ASSEMBLY_NAME_FIELD_NUMBER: _ClassVar[int]
...
class GenomeNameRequest(_message.Message):
    __slots__ = ["ensembl_name", "release_version", "site_name"]
    ENSEMBL_NAME_FIELD_NUMBER: _ClassVar[int]
    RELEASE_VERSION_FIELD_NUMBER: _ClassVar[int]
...
class GenomeSequence(_message.Message):
    __slots__ = ["accession", "chromosomal", "length", "name", "sequence_location"]
    ACCESSION_FIELD_NUMBER: _ClassVar[int]
    CHROMOSOMAL_FIELD_NUMBER: _ClassVar[int]
    LENGTH_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
...
class Organism(_message.Message):
    __slots__ = ["common_name", "ensembl_name", "organism_uuid", "scientific_name", "scientific_parlance_name", "species_taxonomy_id", "strain", "strain_type", "taxonomy_id"]
    COMMON_NAME_FIELD_NUMBER: _ClassVar[int]
    ENSEMBL_NAME_FIELD_NUMBER: _ClassVar[int]
...
class OrganismsGroup(_message.Message):
    __slots__ = ["common_name", "count", "order", "scientific_name", "species_taxonomy_id"]
    COMMON_NAME_FIELD_NUMBER: _ClassVar[int]
...
class Release(_message.Message):
    __slots__ = ["is_current", "release_date", "release_label", "release_type", "release_version", "site_label", "site_name", "site_uri"]
...
class ReleaseRequest(_message.Message):
    __slots__ = ["current_only", "release_label", "site_name"]
...
class Species(_message.Message):
    __slots__ = ["genbank_common_name", "genome_uuid", "scientific_name", "scientific_parlance_name", "synonym", "taxon_id"]
...
class SubSpecies(_message.Message):
    __slots__ = ["organism_uuid", "species_name", "species_type"]
    ORGANISM_UUID_FIELD_NUMBER: _ClassVar[int]
...
class Taxon(_message.Message):
    __slots__ = ["alternative_names", "scientific_name", "strain", "taxonomy_id"]
