...
class Genome(_message.Message):
    __slots__ = ("genome_uuid", "url_name", "assembly", "taxon", "created", "organism", "attributes_info", "related_assemblies_count", "release", "available_datasets")
    ...
    AVAILABLE_DATASETS_FIELD_NUMBER: _ClassVar[int]
    genome_uuid: str
    url_name: str
    assembly: Assembly
    taxon: Taxon
    ...
    release: Release
    available_datasets: _containers.RepeatedScalarFieldContainer[str]
    def __init__(self, genome_uuid: _Optional[str] = ..., url_name: _Optional[str] = ..., assembly: _Optional[_Union[Assembly, _Mapping]] = ..., taxon: _Optional[_Union[Taxon, _Mapping]] = ..., created: _Optional[str] = ..., organism: _Optional[_Union[Organism, _Mapping]] = ..., attributes_info: _Optional[_Union[AttributesInfo, _Mapping]] = ..., related_assemblies_count: _Optional[int] = ..., release: _Optional[_Union[Release, _Mapping]] = ..., available_datasets: _Optional[_Iterable[str]] = ...) -> None: ...

class BriefGenomeDetails(_message.Message):
    __slots__ = ("genome_uuid", "url_name", "assembly", "taxon", "created", "organism", "release", "latest_genome")
    GENOME_UUID_FIELD_NUMBER: _ClassVar[int]
    URL_NAME_FIELD_NUMBER: _ClassVar[int]
    ASSEMBLY_FIELD_NUMBER: _ClassVar[int]
    TAXON_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, genome_uuid: _Optional[str] = ..., url_name: _Optional[str] = ..., assembly: _Optional[_Union[Assembly, _Mapping]] = ..., taxon: _Optional[_Union[Taxon, _Mapping]] = ..., created: _Optional[str] = ..., organism: _Optional[_Union[Organism, _Mapping]] = ..., release: _Optional[_Union[Release, _Mapping]] = ..., latest_genome: _Optional[_Union[BriefGenomeDetails, _Mapping]] = ...) -> None: ...
...
class Assembly(_message.Message):
    __slots__ = ("accession", "name", "ucsc_name", "level", "ensembl_name", "assembly_uuid", "is_reference")
    ACCESSION_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
    ...
    assembly_uuid: str
    is_reference: bool
    def __init__(self, accession: _Optional[str] = ..., name: _Optional[str] = ..., ucsc_name: _Optional[str] = ..., level: _Optional[str] = ..., ensembl_name: _Optional[str] = ..., assembly_uuid: _Optional[str] = ..., is_reference: bool = ...) -> None: ...
...
class Organism(_message.Message):
    __slots__ = ("common_name", "strain", "scientific_name", "ensembl_name", "scientific_parlance_name", "organism_uuid", "strain_type", "taxonomy_id", "species_taxonomy_id", "tol_id")
    ...
    tol_id: str
    def __init__(self, common_name: _Optional[str] = ..., strain: _Optional[str] = ..., scientific_name: _Optional[str] = ..., ensembl_name: _Optional[str] = ..., scientific_parlance_name: _Optional[str] = ..., organism_uuid: _Optional[str] = ..., strain_type: _Optional[str] = ..., taxonomy_id: _Optional[int] = ..., species_taxonomy_id: _Optional[int] = ..., tol_id: _Optional[str] = ...) -> None: ...
...
class OrganismsGroupCount(_message.Message):
    __slots__ = ("organisms_group_count", "release_label")
    ...
    release_label: str
    def __init__(self, organisms_group_count: _Optional[_Iterable[_Union[OrganismsGroup, _Mapping]]] = ..., release_label: _Optional[str] = ...) -> None: ...
...
class ReleaseLabel(_message.Message):
    __slots__ = ("release_label",)
    RELEASE_LABEL_FIELD_NUMBER: _ClassVar[int]
    release_label: str
    def __init__(self, release_label: _Optional[str] = ...) -> None: ...
...
class GroupInfo(_message.Message):
    __slots__ = ("group_id", "group_type", "group_name", "reference_genome")
    GROUP_ID_FIELD_NUMBER: _ClassVar[int]
    GROUP_TYPE_FIELD_NUMBER: _ClassVar[int]
    GROUP_NAME_FIELD_NUMBER: _ClassVar[int]
    REFERENCE_GENOME_FIELD_NUMBER: _ClassVar[int]
    group_id: str
    group_type: str
    group_name: str
    reference_genome: BriefGenomeDetails
    def __init__(self, group_id: _Optional[str] = ..., group_type: _Optional[str] = ..., group_name: _Optional[str] = ..., reference_genome: _Optional[_Union[BriefGenomeDetails, _Mapping]] = ...) -> None: ...

class GenomeGroupsWithReference(_message.Message):
    __slots__ = ("genome_groups",)
    GENOME_GROUPS_FIELD_NUMBER: _ClassVar[int]
    genome_groups: _containers.RepeatedCompositeFieldContainer[GroupInfo]
    def __init__(self, genome_groups: _Optional[_Iterable[_Union[GroupInfo, _Mapping]]] = ...) -> None: ...

class GenomesInGroup(_message.Message):
    __slots__ = ("genomes",)
    GENOMES_FIELD_NUMBER: _ClassVar[int]
    genomes: _containers.RepeatedCompositeFieldContainer[BriefGenomeDetails]
    def __init__(self, genomes: _Optional[_Iterable[_Union[BriefGenomeDetails, _Mapping]]] = ...) -> None: ...

class TaxonomyGroupCount(_message.Message):
...
class GenomeCounts(_message.Message):
    __slots__ = ("total", "counts")
    TOTAL_FIELD_NUMBER: _ClassVar[int]
    COUNTS_FIELD_NUMBER: _ClassVar[int]
    total: int
    counts: _containers.RepeatedCompositeFieldContainer[TaxonomyGroupCount]
    def __init__(self, total: _Optional[int] = ..., counts: _Optional[_Iterable[_Union[TaxonomyGroupCount, _Mapping]]] = ...) -> None: ...
...
class ReleaseInfoRequest(_message.Message):
    __slots__ = ("genome_uuid", "dataset_type", "release_version")
    GENOME_UUID_FIELD_NUMBER: _ClassVar[int]
    DATASET_TYPE_FIELD_NUMBER: _ClassVar[int]
    RELEASE_VERSION_FIELD_NUMBER: _ClassVar[int]
...
class GroupTypeRequest(_message.Message):
    __slots__ = ("group_type", "release_label")
    GROUP_TYPE_FIELD_NUMBER: _ClassVar[int]
    RELEASE_LABEL_FIELD_NUMBER: _ClassVar[int]
    group_type: str
    release_label: str
    def __init__(self, group_type: _Optional[str] = ..., release_label: _Optional[str] = ...) -> None: ...

class GenomesInGroupRequest(_message.Message):
    __slots__ = ("group_id", "release_label")
    GROUP_ID_FIELD_NUMBER: _ClassVar[int]
    RELEASE_LABEL_FIELD_NUMBER: _ClassVar[int]
    group_id: str
    release_label: str
    def __init__(self, group_id: _Optional[str] = ..., release_label: _Optional[str] = ...) -> None: ...

class GenomeCountsRequest(_message.Message):
    __slots__ = ("release_label",)
    RELEASE_LABEL_FIELD_NUMBER: _ClassVar[int]
    release_label: str
    def __init__(self, release_label: _Optional[str] = ...) -> None: ...
