...
# source: ensembl/production/metadata/ensembl_metadata.proto
...
Genome = _reflection.GeneratedProtocolMessageType('Genome', (_message.Message,), {
  'DESCRIPTOR' : _GENOME,
  '__module__' : 'ensembl.production.metadata.ensembl_metadata_pb2'
