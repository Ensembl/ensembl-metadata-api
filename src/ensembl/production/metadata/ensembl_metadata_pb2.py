...
_ENSEMBLMETADATA = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='ensembl_metadata.EnsemblMetadata.GetDatasetsByUUID',
    index=11,
    containing_service=None,
