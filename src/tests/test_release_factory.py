...
class TestReleaseFactory:
    ...
    # def test_release_data_consistency(self, test_dbs) -> None:
    #     """
    #     Ensure all releases pass `check_release()`
    #     """
    #     metadata_db = DBConnection(test_dbs['ensembl_genome_metadata'].dbc.url)
    #     factory = ReleaseFactory(test_dbs['ensembl_genome_metadata'].dbc.url)
    #
    ...
    #                 factory.check_release(release)
    #         except ReleaseDataException:
    #             pytest.fail("All Releases should be valid")
