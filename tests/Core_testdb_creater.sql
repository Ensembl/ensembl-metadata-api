...
#select s.name
insert into seq_region_attrib values(1,3,'ENA');
...
insert into external_db values(50710,'INSDC','','KNOWNXREF',5,'International Nucleotide Sequence Database Collaboration','MISC','INSDC','','Lotsoftext');

################################################################
#Updating Assembly!!
################################################################
create database test_core2;
use test_core2;
CREATE TABLE `meta` (
  `meta_id` int(11) NOT NULL AUTO_INCREMENT,
  `species_id` int(10) unsigned DEFAULT 1,
